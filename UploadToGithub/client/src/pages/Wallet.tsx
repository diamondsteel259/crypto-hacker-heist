      ...
      <div className="max-w-5xl mx-auto p-2 md:p-4 space-y-3 md:space-y-6">
        ...
        <Card className="p-4 md:p-6">
          ...
          <div className="text-center py-4 md:py-6">
            <p className="text-3xl md:text-5xl font-bold font-mono text-matrix-green matrix-glow mb-1 md:mb-2">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-4 mt-4 md:mt-6 pt-4 md:pt-6 border-t border-border">
            <div className="text-center">
              ...
              <p className="text-sm md:text-lg font-bold font-mono">52,430</p>
            </div>
            <div className="text-center">
              <p className="text-[10px] md:text-xs text-muted-foreground mb-1">From Mining</p>
              <p className="text-sm md:text-lg font-bold font-mono text-matrix-green">48,100</p>
            </div>
            <div className="text-center">
              <p className="text-[10px] md:text-xs text-muted-foreground mb-1">From Referrals</p>
              <p className="text-sm md:text-lg font-bold font-mono text-cyber-blue">4,330</p>
            </div>
          </div>
        </Card>
