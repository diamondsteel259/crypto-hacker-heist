...
export default function Shop() {
  ...
  // IMMEDIATE TEST - This should show if component loads
  return (
    <div className="min-h-screen bg-background p-3">
      <div className="max-w-7xl mx-auto space-y-4">
        <div className="flex items-center gap-3 mb-4">
          <ShoppingBag className="w-6 h-6 text-matrix-green" />
          <h1 className="text-xl font-bold terminal-gradient">EQUIPMENT SHOP - TEST</h1>
        </div>
        <Card className="p-8 text-center">
          <p className="text-muted-foreground">Shop component is loading!</p>
